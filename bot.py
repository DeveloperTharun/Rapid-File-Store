    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        await message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("Convert To Link", callback_data="addToBatchFalse")]
            ]),
            quote=True,
            disable_web_page_preview=True
        )
...
async def button(bot: Client, cmd: CallbackQuery):
    ...
    if "aboutbot" in cb_data:
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/Rapid_Bots).",
                        disable_web_page_preview=True
                    )
                    return
        ...
        await cmd.message.edit("File Saved in Batch!\n\n"
                               ...
                               reply_markup=InlineKeyboardMarkup([
                                   [InlineKeyboardButton("Conver To Batch Link", callback_data="getBatchLink")],
